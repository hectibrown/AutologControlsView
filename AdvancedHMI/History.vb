...
Public Class History
    ...
    Private Sub BasicDataLogger21_DataChanged(sender As Object, e As Drivers.Common.PlcComEventArgs)
    ...
    Dim LugData(10) As Int32
    Dim szLugData(10) As String
    Dim dIdx As Int32
    Dim dIdxSz As Int32
    Dim stRxOpti As RxOptiTrimmerSolution
    Dim dTestLugIdx As Int32
    Dim stLugData As StLugData
    ...
    Private Sub DataSubscriber21_DataChanged(sender As Object, e As Drivers.Common.PlcComEventArgs) Handles DataSubscriber21.DataChanged
        ...
        If dLugId > -1 And dLugId < 200 Then
            stLugData = EthernetIPforCLXCom2.ReadUDT(Of StLugData)("g_ActLug.Data[" & CStr(dLugId) & "]")
            If dLastLugId <> dLugId And Not bPauseHistory Then
                Dim timeStamp1 As DateTime = DateTime.Now
                'Achifer sur le tableau
                Call DestToString(stLugData.BaseData.dDestination(0), stLugData.OptiRx.dDestination(0))
